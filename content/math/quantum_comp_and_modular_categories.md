...
Mathematically, the collection of all these trajectories for some fixed \\( n \\) particles--so long as we disallow the strands reversing direction--form a group under composition: it is the **braid group on \\( n \\) strands**, denoted \\( \mathcal{B}\_n \\).
...
Kitaev (<a href="#citeproc_bib_item_3">Kitaev 2006</a>) posited that the algebraic combinatorics of the solutions to these equations can be formalized in the language of **unitary modular categories**.

The language of categories came about as a way to unify analogous phenomena that occur in seemingly unrelated areas of mathematics.
...
The interested reader can refer to Figure [3](#org3d99d69) for a tree of what each of these terms imply.
...
The reader might ask if the &ldquo;braiding&rdquo; in Figure [3](#org3d99d69) is related to the braiding discussed for anyons.
Indeed they are, the braiding of a unitary modular category corresponds to braiding of anyons.
There is an expansive &ldquo;dictionary&rdquo; of the correspondence between unitary modular categories and the physical interpretation of what the data represent.
This table can be found in more detail in (<a href="#citeproc_bib_item_4">Rowell and Wang 2018</a>).
...
<div class="table-caption">
  ...
  Synonyms from the unitary modular category realm and anyon system world
</div>
...
Classifying unitary modular categories up to some good notion of equivalence is therefore equivalent to classifying systems of anyons.
...
For a proof via nice exercises, see (<a href="#citeproc_bib_item_2">Etingof et al. 2016</a>).

Classifying modular categories, and their more refined cousins--spin modular categories--is an ongoing project.
This task enjoys deep connections to representation theory, quantum field theory, and condensed matter physics.
Whether or not it is possible remains to be seen, and it is doubtless more questions will endure into the future.
