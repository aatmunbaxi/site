...
** DRAFT Quantum Computing and Modular Categories :math:
:PROPERTIES:
:EXPORT_HUGO_SECTION: math
:EXPORT_FILE_NAME: quantum_comp_and_modular_categories
:END:

Quantum computing is an exciting new paradigm of computation, promising exponential speedup from state-of-the-art classical algorithms in certain computing tasks.
...
- [[id:0adf10d9-1ea5-4db2-a8bb-6641fab04ea3][modular categories]] effectively model systems of anyon quasiparticles, the main ingredient to TQC (Kitaev)
