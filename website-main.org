...
** DRAFT From Brain to Binary: The Bliss of Declarative Programming :programming:
:PROPERTIES:
:EXPORT_HUGO_SECTION: computing
...
From my time with C++ and Python, I had developed a (not unreasonable) notion that programming was all about telling computers /what/ to do.
