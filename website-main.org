...
** DRAFT Solving the Magic Square in Common Lisp          :lisp:programming:
:PROPERTIES:
:EXPORT_HUGO_SECTION: comp
:EXPORT_FILE_NAME: magic-square-common-lisp
:END:
#+include: ~/programming/lisp-fun/magic-square.org
** DRAFT Declarative Programming for Fast Brain-to-Binary
:PROPERTIES:
:EXPORT_HUGO_SECTION: comp
...
** DRAFT Consistent, Dynamic Access to Custom Emacs Theme Palettes with technicolor :emacs:
:PROPERTIES:
:EXPORT_HUGO_SECTION: comp
:EXPORT_FILE_NAME: dyn_custom_palette_access_technicolor
:EXPORT_DATE: 2024-07-05
:END:
...
The green from the previous DOOM theme palette sticks out as very /wrong/ here.
